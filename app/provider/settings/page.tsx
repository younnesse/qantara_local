  ...
  const settingsGroups = [
    {
      ...
      items: [
        { label: t("settings.editProfile"), icon: User, href: "/provider/edit-profile" },
        { label: t("settings.privacySecurity"), icon: Shield, href: "/provider/privacy" },
      ],
    },
    {
      title: t("settings.business"),
      items: [
        { label: t("settings.paymentMethods"), icon: CreditCard, href: "/provider/payments" },
        { label: t("settings.manageServices"), icon: FileText, href: "/provider/services" },
      ],
    },
    {
                  ...
                  {([
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-sm ${locale === lang.code ? "font-semibold text-primary" : "text-foreground"}`}>{lang.label}</span>
                      </div>
                  ...
                  {([
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`text-sm ${theme === opt.key ? "font-semibold text-primary" : "text-foreground"}`}>{opt.label}</span>
                      </div>
